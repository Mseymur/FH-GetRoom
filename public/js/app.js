    ...
    async function fetchRoomStructure(buildingToFetchFor) {
        ...
        try {
            ...
            if (fetchedStructure.building !== buildingToFetchFor) {
                ...
                showMessage(errorMessageEl, `Data mismatch:Click "Refresh Schedule" Expected structure for ${buildingToFetchFor} but received for ${fetchedStructure.building}. Please try re-selecting building.`, true);
                return false;
            }
